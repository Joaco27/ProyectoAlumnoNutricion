...
public class FondoD1 extends JPanel{
	...
	public void tresCorazones(JLabel j) {
		Icon img = new ImageIcon(new ImageIcon(getClass().getResource("/imagenes/tresCorazones.png")).getImage()
	...
	public void unCorazon(JLabel j) {
		Icon img = new ImageIcon(new ImageIcon(getClass().getResource("/imagenes/unCorazon.png")).getImage()
				.getScaledInstance(j.getWidth(), j.getHeight(), 0));
